...
# ==============================================================================
# CSS CAO CẤP: BIẾN BỘ LỌC THÀNH FLOATING PANEL THU PHÓNG ĐÈ LÊN BẢN ĐỒ
# ==============================================================================
st.markdown(
    """
    <style>
    ...
    /* CẤU HÌNH CỘT CHỨA BỘ LỌC TRONG SUỐT (ĐỂ KHI THU NHỎ LÀ BIẾN MẤT HOÀN TOÀN) */
    ...
    /* ĐỔ MÀU NỀN TRẮNG VÀ ĐỔ BÓNG TRỰC TIẾP LÊN EXPANDER (THU PHÓNG SẼ CO DÃN THEO RUỘT) */
    .stExpander {
    ...
    /* ÉP CỐ ĐỊNH MÀU CHỮ TRONG KHU VỰC BỘ LỌC - CHỐNG LỖI MẤT CHỮ TRÊN ĐIỆN THOẠI NỀN ĐEN */
    ...
    div[data-testid="column"]:nth-of-type(1) div {
        color: #0F172A !important; /* Luôn là màu chữ tối rõ ràng */
    }
    
    /* Chỉnh chữ tiêu đề thanh Thu phóng/Mở rộng nổi bật */
    .stExpander summary p {
        font-weight: 700 !important;
        color: #1E3A8A !important;
    }
    
    /* Đảm bảo ô nhập liệu luôn có nền trắng chữ đen rõ nét */
...
# ==============================================================================
    ...
    # Layout chia cột: cột 1 chứa bộ điều khiển lơ lửng, cột 2 là bản đồ full diện tích màn hình
    ...
    try:
        ...
        with col_left_search:
            # Thanh bộ lọc có thể thu vào / mở ra mượt mà ngay trên góc bản đồ
        ...
        with col_right_map:
            # Bản đồ siêu rộng cao 720px full viền điện thoại cực đẹp
