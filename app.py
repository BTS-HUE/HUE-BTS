...
# ==============================================================================
# 1. KHỞI TẠO & QUẢN LÝ PHIÊN ĐĂNG NHẬP
# ==============================================================================
st.set_page_config(page_title="Hệ Thống Trạm Phát Sóng", layout="wide", initial_sidebar_state="collapsed")

cookies = CookieController()

# Đọc token từ cookie trình duyệt (Tự động kích hoạt rerun tự nhiên khi tải xong)
auth_cookie = cookies.get("bts_logged_in")

# Đồng bộ hóa trạng thái phiên làm việc tự động và mượt mà
...
if not st.session_state.logged_in:
    ...
    if tai_khoan_nhap == TAI_KHOAN_CHUAN and mat_khau_nhap == MAT_KHAU_CHUAN:
        st.session_state.logged_in = True
        cookies.set("bts_logged_in", "authenticated_secure_token_tuan")
        st.rerun()
